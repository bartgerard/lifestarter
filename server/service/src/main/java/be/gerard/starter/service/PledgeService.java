...
public class PledgeService {
    ...
    private static final List<Pledge> PLEDGES = Arrays.asList(
            ...
            Pledge.builder()
                    ...
                    .description("Diamanten zijn voor altijd en zo ook het album bij deze pledge. De fotograaf drukt het finale fotoboek op ultra duurzaam materiaal. Zo kun je onze mooie dag, nog door enkele generaties na ons laten herbeleven.")
                    .content("2x Toegang tot alle festiviteiten")
